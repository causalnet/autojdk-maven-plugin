...
class TestJdk
{
    ...
    void jvmVersion()
    {
        assertThat(ManagementFactory.getRuntimeMXBean().getSpecVersion()).isEqualTo("19");
        assertThat(ManagementFactory.getRuntimeMXBean().getVmVersion()).contains("-ea"); //Ensure it's an early access version
    }
}
